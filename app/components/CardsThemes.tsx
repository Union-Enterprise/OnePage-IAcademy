...
export function CardsThemes() {
    const contents = [
        ...
        {
            title: 'Probabilidade',
            description: 'Probabilidade é o estudo de eventos aleatórios, ajudando a entender a chance de diferentes resultados em experimentos.',
            icon: <Cuboid />,
        },
        {
            title: 'Geometria Espacial',
            description: 'Geometria Espacial examina figuras tridimensionais, como cubos, esferas e pirâmides, explorando conceitos como volume e área.',
            icon: <Box />,
        },
        {
            title: 'Topologia',
