...
export function CardsInfo(){
    return(
    <div className="relative z-30 grid grid-cols-3 gap-14  px-10 mt-96 ml-20 ">
        <div className="bg-white border shadow-lg rounded-lg p-6 grid grid-flow-row w-80 h-72 items-center ">
          <div>
            ...
            Descubra fatos interessantes sobre o exame que define futuro</p>
          </div>
      ...
      <div className=" shadow-lg rounded-lg  grid grid-flow-row w-72 ">
          ...
          <div className="bg-white border shadow-lg rounded-lg p-6 grid grid-flow-row w-96 h-64  ">
            <div>
                <h1 className="text-2xl text-green-400">
                Conteúdo Personalizado
                </h1>
                <h1 className="text-2xl text-mainBlue pb-1 ">
                Seu estudo, nosso foco
                </h1>
                <p className="text-sm text-zinc-600 pb-1">Utilizamos inteligência artificial para adaptar o material de estudo às necessidades e ao ritmo de cada aluno, garantindo um aprendizado mais eficiente e direcionado.</p>
          ...
          <div className="grid grid-flow-row w-full h-full ">
            <div className="relative rounded-lg w-full h-full overflow-hidden">
              ...
              <p className="absolute bottom-1 left-4 text-white text-xl font-semibold hover:text-mainBlue transition-all cursor-pointer">Explorar</p>
            </div>
          </div>
