    ...
    return(
        <><div className="relative ">
            <svg
                ...
                className="absolute top-0 mr-96"
            >
                <defs>
                    <clipPath id="9161c52052">
                        <path d="M 0 50 L 996.90625 50 L 996.90625 575.859375 L 0 575.859375 Z M 0 50" clip-rule="nonzero" />
                    </clipPath>
                </defs>
                <g clip-path="url(#9161c52052)">
                    <path
                        fill="#1865f2"
                        d="M 996.359375 575.859375 L 0.546875 575.859375 C 19.875 396.835938 126.679688 501.726562 233.480469 393.785156 C 430.8125 194.421875 583.386719 364.289062 657.640625 182.214844 C 731.894531 0.140625 996.359375 59.136719 996.359375 59.136719 Z M 996.359375 575.859375"
                        fill-opacity="1"
                        fill-rule="nonzero" />
                </g>
            </svg>
            ...
            <div className="relative z-30 grid grid-cols-3 gap-8  px-10 ml-52">
                ...
                <div className="bg-white border shadow-lg rounded-lg grid grid-cols-2 justify-between col-span-2 w-[700px]">
                    ...
                    <div className="p-2">
                        ...
                        <h1 className="flex justify-center text-2xl mt-2">Preparação <p className="text-mainBlue ml-1"> Premium</p> </h1>
                        <h1 className="flex justify-center text-2xl">para <p className="text-mainBlue ml-1">Vestibulares</p></h1>
                        <p className="mt-4 flex  "> <BadgeCheck className="text-green-600 w-5 h-5 mr-4" />Livre de anúncios</p>
                        <p className="mt-4 flex  mr-20 "><BadgeCheck className="text-green-600 w-5 h-5 mr-3" /> Quizzes</p>
                ...
                <div className="bg-white border shadow-lg rounded-lg grid grid-cols-2 justify-between col-span-2 w-[700px] overflow-hidden">
                    <div className="bg-zinc-100 w-full h-full p-4">
                        ...
                        <h1 className="text-2xl flex mt-3">Aassine o plano <p className="text-mainBlue ml-1">Premium</p></h1>
